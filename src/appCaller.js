...
export const deployContract = async (peraWallet,accountAddress) => {
    ...
    try {
            ...
            const txn = algosdk.makeApplicationCreateTxnFromObject({
                ...
                approvalProgram: new Uint8Array(Buffer.from(APP_SPEC.source.approval, 'base64')),
                clearProgram: new Uint8Array(Buffer.from(APP_SPEC.source.clear, 'base64')),
                numGlobalInts: 0, // num global ints
                numGlobalByteSlices: 0, // num global byteslices
                numLocalInts: 0, // num local ints
                numLocalByteSlices: 0,
                extraPages:3  // num local byteslices
        });
            // Firmar la transacción usando Pera Wallet
